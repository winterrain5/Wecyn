...
class AdminEditStaffContainer: UIView {
    ...
    var newRequestModel = AdminCertificatStaffRequestModel()
    ...
    var newModel:AdminNewStaffModel? {
        didSet {
            ...
            newRequestModel.id = model.id
            newRequestModel.org_id = model.org_id
            newRequestModel.status = 1
    ...
    override func awakeFromNib() {
        ...
        departmentButton.rx.tap.subscribe(onNext:{ [weak self] in
            ...
            vc.selectComplete = {
                ...
                self.newRequestModel.dept_id = $0.id
            }
        ...
        roleButton.rx.tap.subscribe(onNext:{ [weak self] in
            ...
            vc.selectComplete = {
                ...
                self.roleDepartmentContainer.isHidden = $0.id == 0
                
                self.requestModel.role_id = $0.id
                self.newRequestModel.role_id = $0.id
        ...
        roleDepartmentButton.rx.tap.subscribe(onNext:{ [weak self] in
            ...
            vc.selectComplete = {
                ...
                self.newRequestModel.role_dept_id = $0.id
        ...
        submitButton.rx.tap.subscribe(onNext:{ [weak self] in
            ...
            if let _ = self.newModel {
               
                AdminService.staffCertificate(model: self.newRequestModel).subscribe(onNext:{
                    if $0.success == 1 {
