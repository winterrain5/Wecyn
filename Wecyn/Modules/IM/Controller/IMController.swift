...
class IMController:NSObject {
    ...
    static let shared = IMController()
...
extension IMController {
    ...
    public func inviteUsersToGroup(groupId: String, uids: [String], onSuccess: @escaping CallBack.VoidReturnVoid) {
        Self.shared.imManager.inviteUser(toGroup: groupId, reason: "", usersID: uids) { msg in
            onSuccess()
        } onFailure: { code, msg in
...
extension IMController {
    ...
    public func sendAtTextMessage(text: String,
        ...
        let message = OIMMessageInfo.createText(atMessage: text,
...
extension IMController {
    ...
    public func getLoginStatus()  -> OIMLoginStatus {
        Self.shared.imManager.getLoginStatus()
    }
}
...
extension MessageContentType:CustomDebugStringConvertible {
    public var debugDescription: String {
        ...
        case .advancedText:
            return "advancedText"
        case .reactionMessageModifier:
            return "reactionMessageModifier"
        case .reactionMessageDeleter:
            return "reactionMessageDeleter"
        case .friendAppApproved:
            return "friendAppApproved"
        case .friendAppRejected:
            return "friendAppRejected"
        case .friendApplication:
        ...
        case .friendRemarkSet:
            return "friendRemarkSet"
        case .blackAdded:
            return "blackAdded"
        case .blackDeleted:
            return "blackDeleted"
        case .conversationOptChange:
            return "conversationOptChange"
        case .userInfoUpdated:
            return "userInfoUpdated"
        case .conversationNotification:
            return "conversationNotification"
        case .conversationNotNotification:
            return "conversationNotNotification"
        case .oaNotification:
        ...
        case .groupInfoSet:
            return "groupInfoSet"
        case .joinGroupApplication:
            return "joinGroupApplication"
        case .memberQuit:
            return "memberQuit"
        case .groupAppAccepted:
            return "groupAppAccepted"
        case .groupAppRejected:
            return "groupAppRejected"
        case .groupOwnerTransferred:
            return "groupOwnerTransferred"
        case .memberKicked:
            return "memberKicked"
        case .memberInvited:
        ...
        case .groupHasReadReceipt:
            return "groupHasReadReceipt"
        default:
            return "unknown"
        }
    }
