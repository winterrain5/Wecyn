...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CodeTextField/CodeTextField.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DKEmptyDataSet/DKEmptyDataSet.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FYVideoCompressor/FYVideoCompressor.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ImagePickerSwift/ImagePickerSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MMBAlertsPickers/MMBAlertsPickers.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RichLabel/RichLabel.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SafeSFSymbols/SafeSFSymbols.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftExtensionsLibrary/SwiftExtensionsLibrary.framework"
