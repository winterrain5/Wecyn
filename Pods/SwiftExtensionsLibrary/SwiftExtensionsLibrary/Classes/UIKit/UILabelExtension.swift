...
// MARK: - 二、其他的基本扩展
public extension ExtensionBase where Base: UILabel {
...
public extension ExtensionBase where Base: UILabel {
    ...
    func setRangeFontText(font: UIFont, range: NSRange) {
        let attributedString = base.attributedText?.sk.setRangeFontText(font: font, range: range)
    ...
    func setsetSpecificTextFont(_ text: String, font: UIFont) {
        let attributedString = base.attributedText?.sk.setSpecificTextFont(text, font: font)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeTextColor(color: UIColor, range: NSRange) {
        let attributedString = base.attributedText?.sk.setSpecificRangeTextColor(color: color, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextColor(_ text: String, color: UIColor) {
        let attributedString = base.attributedText?.sk.setSpecificTextColor(text, color: color)
        base.attributedText = attributedString
    }
    ...
    func setTextLineSpace(_ space: CGFloat) {
        let attributedString = base.attributedText?.sk.setSpecificRangeTextLineSpace(lineSpace: space, alignment: base.textAlignment, range: NSRange(location: 0, length: base.text?.count ?? 0))
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeTextUnderLine(color: UIColor, stytle: NSUnderlineStyle = .single, range: NSRange) {
        let attributedString = base.attributedText?.sk.setSpecificRangeUnderLine(color: color, stytle: stytle, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextUnderLine(_ text: String, color: UIColor, stytle: NSUnderlineStyle = .single) {
        let attributedString = base.attributedText?.sk.setSpecificTextUnderLine(text, color: color, stytle: stytle)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeDeleteLine(color: UIColor, range: NSRange) {
        let attributedString = base.attributedText?.sk.setSpecificRangeDeleteLine(color: color, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextDeleteLine(_ text: String, color: UIColor) {
        let attributedString = base.attributedText?.sk.setSpecificTextDeleteLine(text, color: color)
        base.attributedText = attributedString
    }
    ...
    func insertImage(imgName: String, imgBounds: CGRect = .zero, imgIndex: Int = 0) {
        ...
        let attributedString = base.attributedText?.sk.insertImage(imgName: imgName, imgBounds: imgBounds, imgIndex: imgIndex)
        base.attributedText = attributedString
    }
    ...
    func firstLineLeftEdge(_ edge: CGFloat) {
        let attributedString = base.attributedText?.sk.firstLineLeftEdge(edge)
        base.attributedText = attributedString
    }
    ...
    func setSpecificRangeBliqueness(inclination: Float = 0, range: NSRange) {
        let attributedString = base.attributedText?.sk.setSpecificRangeBliqueness(inclination: inclination, range: range)
        base.attributedText = attributedString
    }
    ...
    func setSpecificTextBliqueness(_ text: String, inclination: Float = 0) {
        let attributedString = base.attributedText?.sk.setSpecificTextBliqueness(text, inclination: inclination)
        base.attributedText = attributedString
    }
}
